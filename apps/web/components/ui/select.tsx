...
>(({ className, children, ...props }, ref) => (
  ...
  >
    {children}
    <SelectPrimitive.Icon aria-hidden className="ms-2 text-xs opacity-60">
      &#9660;
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    ...
    <SelectPrimitive.ItemIndicator className="absolute end-2 text-xs">&#10003;</SelectPrimitive.ItemIndicator>
  </SelectPrimitive.Item>
));
