...
import { signAccessToken, signRefreshToken, verifyRefreshToken, signEmailVerificationToken, verifyEmailVerificationToken, signPasswordResetToken, verifyPasswordResetToken, } from "../utils/jwt.js";
import { sha256Hex } from "../utils/hash.js";
import { sendVerificationEmail, sendPasswordResetEmail } from "./email.service.js";
import { env } from "../config/env.js";
const REFRESH_TTL_MS = 7 * 24 * 60 * 60 * 1000;
async function issueTokenPair(userId, role, permissions) {
    ...
    const accessToken = signAccessToken({ sub: userId, role: role, permissions: permissions ?? undefined });
