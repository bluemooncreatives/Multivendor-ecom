...
import { classifiedSchema, moderateClassifiedSchema, listClassifiedsHandler, createClassifiedHandler, listMyClassifiedsHandler, updateClassifiedHandler, deleteClassifiedHandler, moderateClassifiedHandler, } from "../controllers/classified.controller.js";
import { getAffiliateConfigHandler, joinAffiliateHandler, getMyAffiliateHandler, listMyAffiliateEarningsHandler, createAffiliateWithdrawHandler, affiliateWithdrawSchema, } from "../controllers/affiliate.controller.js";
import { getMyClubPointsHandler, listMyClubPointHistoryHandler } from "../controllers/clubpoints.controller.js";
import { refundRequestSchema, resolveRefundSchema, createRefundRequestHandler, listMyRefundRequestsHandler, listSellerRefundRequestsHandler, resolveRefundRequestHandler, } from "../controllers/refund.controller.js";
import { listSellerPackagesHandler, listCustomerPackagesHandler, purchasePackageSchema, purchaseSellerPackageHandler, purchaseCustomerPackageHandler, } from "../controllers/package.controller.js";
...
addonRouter.post("/classifieds/:id/moderate", authenticate, requirePermission("catalog.moderate"), validateBody(moderateClassifiedSchema), asyncHandler(moderateClassifiedHandler));
// --- Affiliate program ---
...
addonRouter.post("/affiliate/withdrawals", authenticate, validateBody(affiliateWithdrawSchema), asyncHandler(createAffiliateWithdrawHandler));
// --- Club points ---
...
addonRouter.post("/refunds/:id/resolve", authenticate, requirePermission("orders.manage"), validateBody(resolveRefundSchema), asyncHandler(resolveRefundRequestHandler));
...
addonRouter.post("/packages/seller/purchase", authenticate, requireRole("seller"), validateBody(purchasePackageSchema), asyncHandler(purchaseSellerPackageHandler));
addonRouter.post("/packages/customer/purchase", authenticate, validateBody(purchasePackageSchema), asyncHandler(purchaseCustomerPackageHandler));
