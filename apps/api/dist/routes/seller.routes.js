...
import { shopSchema, getMyShopHandler, createOrUpdateShopHandler, getPublicShopHandler, getSellerLedgerSummaryHandler, listSellerLedgerHandler, createWithdrawRequestHandler, listMyWithdrawRequestsHandler, withdrawRequestSchema, fulfillOrderItemHandler, } from "../controllers/seller.controller.js";
...
sellerRouter.post("/withdrawals", authenticate, requireRole("seller"), validateBody(withdrawRequestSchema), asyncHandler(createWithdrawRequestHandler));
