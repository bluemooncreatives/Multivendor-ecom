...
import { getPageBySlugHandler, listPagesHandler, createPageHandler, updatePageHandler, deletePageHandler, getPolicyHandler, upsertPolicyHandler, listLinksHandler, createLinkHandler, updateLinkHandler, deleteLinkHandler, pageSchema, upsertPolicySchema, linkSchema, } from "../controllers/cms.controller.js";
...
cmsRouter.patch("/admin/pages/:id", authenticate, requirePermission("settings.manage"), validateBody(pageSchema.partial()), asyncHandler(updatePageHandler));
...
cmsRouter.put("/admin/policies/:type", authenticate, requirePermission("settings.manage"), validateBody(upsertPolicySchema), asyncHandler(upsertPolicyHandler));
// Links
...
cmsRouter.patch("/admin/links/:id", authenticate, requirePermission("settings.manage"), validateBody(linkSchema.partial()), asyncHandler(updateLinkHandler));
