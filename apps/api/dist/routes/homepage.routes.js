...
import { getHomepageSectionsHandler, listAdminSlidersHandler, createSliderHandler, updateSliderHandler, deleteSliderHandler, listAdminBannersHandler, createBannerHandler, updateBannerHandler, deleteBannerHandler, listAdminHomeCategoriesHandler, createHomeCategoryHandler, deleteHomeCategoryHandler, toggleTopCategoryHandler, toggleTopBrandHandler, sliderSchema, bannerSchema, homeCategorySchema, toggleTopSchema, } from "../controllers/homepage.controller.js";
...
homepageRouter.patch("/admin/top-categories/:id", ...manage, validateBody(toggleTopSchema), asyncHandler(toggleTopCategoryHandler));
